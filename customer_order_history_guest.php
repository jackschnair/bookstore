...
$query = "SELECT DISTINCT * FROM orders A, book B, in_order C WHERE A.Order_Num = '$Order_Num' AND A.Order_Num = C.Order_Num AND B.ISBN = C.ISBN AND B.Book_Cond = C.Book_Cond";
