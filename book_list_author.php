...
$query = "SELECT title, author, genre, ISBN, Book_Cond, type, price, trade_value FROM book WHERE author = (SELECT name FROM author WHERE name = (SELECT is_author FROM customer WHERE email = '$Email'))";
